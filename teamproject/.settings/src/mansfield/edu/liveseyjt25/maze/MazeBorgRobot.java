 ...
 */
public class MazeBorgRobot extends MazeShape {
	BufferedImage image = null;
	private Random gen = new Random();
	private AController control;
	private AView view;
	static String name1 = "borg1";
	static String name2 = "borg2";
	static String name3 = "borg3";
	static final int size = 297;

	public MazeBorgRobot(int myRow, int myCol) {
		super(myRow, myCol, name1);
		try {
			java.net.URL imageURL = MazeBorgRobot.class
