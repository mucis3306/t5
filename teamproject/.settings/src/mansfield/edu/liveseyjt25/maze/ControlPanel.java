...
public class ControlPanel extends JPanel {
	...
	private String[] playerShapeStrings = { "fred", "sally", "cowboy", "dinosaur", "fox", "ninja", "nurse","penguin","pirate","police","princess","samurai","shark","soldier","borg", "circle", "triangle" };
	...
	JTextField nameTF;
	JButton lastBtn, nextBtn, againBtn, fastBtn, midBtn, slowBtn;
