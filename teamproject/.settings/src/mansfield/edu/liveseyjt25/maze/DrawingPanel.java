...
public class DrawingPanel extends JPanel {
	...
	public void setup(MazeBoard board, MazeShape human,
			MazeRobot robot1, MazeRobot robot2, MazeRobot robot3, MazeBorgRobot borg1,MazeBorgRobot borg2,MazeBorgRobot borg3) {
		this.board = board;
		this.human = human;
		this.robot1 = robot1;
		this.robot2 = robot2;
	...
	public void drawPlayer(MazeShape ms, Graphics g) {
		...
		else if (name.equals("borg1")) {
			MazeBorgRobot mr = (MazeBorgRobot) ms;
			int dx2 = startX + mazeSquareSize;
			int dy2 = startY + mazeSquareSize;
			int srcSize = mr.getSize();
			g.drawImage(mr.getImage(), startX, startY, dx2, dy2, 0,
